...
import stackImage from '../assets/about/portfolio_image.png';
...
const About = () => {
  return (
    <section id="about" className="bg-[#6D28D9] pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans">
