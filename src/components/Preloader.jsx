    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#6D28D9] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-purple-900/30">
              Rahul<span className="text-purple-900/30">.</span>
            </div>
            ...
            >
              Rahul<span className="text-black">.</span>
            </motion.div>
          </motion.div>
