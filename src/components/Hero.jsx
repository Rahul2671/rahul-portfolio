...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full h-screen overflow-hidden bg-black">
      ...
      >
        <source src="/hero_video/tech_background.mp4" type="video/mp4" />
      ...
      <div className="absolute inset-0 z-20 px-6 pb-20 md:pb-[8%] md:px-12 max-w-7xl mx-auto flex flex-col md:flex-row justify-end md:justify-between items-start md:items-end text-left w-full">
        ...
        <div className="flex flex-col items-start text-left max-w-2xl w-full">
          ...
          >
            Hi, I'm <br />
            <span className="text[-webkit-text-stroke:1.5px_white]">
            Rahul
            </span>
          </h1>
          ...
          >
            ...
            <a href="/RAHUL_Resume_new.pdf" download className=" px-4 py-2 md:px-6 md:py-2 text-xs md:text-base rounded-full bg-black/40 border border-white text-white font-semibold hover:bg-black/60 transition-all duration-300 backdrop-blur-md">Download my Resume
            </a>
          </div>
        </div>
        ...
        <div 
          ...
          onClick={toggleVideo}
        >
          <div className="w-12 h-12 md:w-20 md:h-20 rounded-full border border-white/30 bg-black/20 backdrop-blur-md flex justify-center items-center group-hover:scale-110 group-hover:bg-[#6D28D9] transition-all duration-500 shadow-[0_0_30px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_40px_rgba(255,42,42,0.6)]">
            {!isPlaying || isMuted ? (
              // Play Icon
          ...
          <span className="text-white text-[10px] md:text-xs font-bold tracking-widest uppercase opacity-70 group-hover:opacity-100 transition-opacity">
            {!isPlaying || isMuted ? "Play Introduction" : "Pause"}
          </span>
        </div>
      </div>
